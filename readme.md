...
- The response body should contain a JSON representation of the message sidentified by the message_id. It is expected for the response body to simply be empty if there is no such message. The response statu should always be 200, which is the default.
